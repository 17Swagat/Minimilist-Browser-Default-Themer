...
//     React.useEffect(() => {
//         if (siteFavicon) {
//             setCurrentFaviconUrl(siteFavicon);
//         } else {
//             const sources = getHighQualityIcons(siteUrl, siteName);
//             setCurrentFaviconUrl(sources[0]);
//         }
//     }, [siteFavicon, siteUrl, siteName]);
...
//     const handleImageError = () => {
//         const faviconSources = siteFavicon ? 
//             [siteFavicon, ...getHighQualityIcons(siteUrl, siteName)] : 
//             getHighQualityIcons(siteUrl, siteName);
...
//             setCurrentFaviconUrl(faviconSources[nextAttempt]);
...
//     return (
//         <div className="w-[100px] h-[100px] rounded-2xl bg-green-300" onClick={()=>openUrlInNewTab(siteUrl)}>
            
//             {/* FavIcon Website */}
//             <div className="w-full h-2/3 bg-amber-500">
//                 <img src={siteFavicon} alt={`None`} className="w-full h-full object-center" />
//             </div>
